...
<div class="container">
    <div class="text-3xl">
        <h1 class="font-Kanit-Black"><i class="fa-solid fa-list-check fa-beat"></i> Data Hasil SAW</h1>
    </div>
    @if(session('message'))
            ...
            <tbody class="text-center">
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4x space-x-3">
                        ...
                        <a href="{{ route('saw.view', ['id' => $lowkers->id ]) }}" class="font-medium hover:underline"><i class="fa-solid fa-circle-info fa-beat" style="color: #ffffff;"></i></a>
                    </td>
                @empty($lowker)
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
