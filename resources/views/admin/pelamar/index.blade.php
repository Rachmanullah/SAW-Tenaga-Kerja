                                ...
                                <div class="px-6 py-6 lg:px-8">
                                    ...
                                    <form class="space-y-1" action="{{ route('pelamar.print') }}" method="post">
                                        ...
                                        <div class="grid md:grid-cols-2 md:gap-5">
                                            ...
                                            <div>
                                                <label for="pendidikan_akhir" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pendidikan Akhir</label>
                                                <input type="text" name="pendidikan_akhir" id="pendidikan_akhir" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="{{ $pelamars->pendidikan_akhir }}" required>
                                            </div>
                                        </div>
